...
// pyfm060 : キャンセル規定一覧 SizeList
class SizeList extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: Column(
        children: [
          StreamBuilder(
            stream: _database.child('size').orderByKey().onValue,
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData) {
                ...
                myUsers.forEach((keyUser, value) {
                  ...
                  final nextUser =
                      SizeModel.fromRTDB(Map<String, dynamic>.from(value));
